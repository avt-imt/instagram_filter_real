...
based on https://github.com/Telecommunication-Telemedia-Assessment/avt_ai_images/tree/main/features
with adjustments, so it can run with `uv`
...
* run with `uv run imt.py` (should automatically handle all dependencies)
