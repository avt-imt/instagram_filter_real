...
def extract_features(imagefilename):
    ...
    try:
        ...
        print(e)
        return {}
    # checkout https://github.com/V-Sense/colornet-estimating-colorfulness
    # checkout https://github.com/V-Sense/Aesthetic-Image-Captioning-ICCVW-2019
    # checkout https://mahotas.readthedocs.io/en/latest/index.html