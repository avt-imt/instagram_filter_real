    ...
    <input type="hidden" value="-1" id="quality_meta" name="quality_meta" /> <!-- meta data for video playback (e.g. stalling, dropped frames) -->
    <input type="hidden" value="0" id="pi" name="pi" /> <!-- play iterations (counter how often the play button was hit) -->
